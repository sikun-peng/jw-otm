...
from constants import USER_AGENT_NUM, WILLIAMSON_COUNTY_ZIP, WILLIAMSON_COUNTY_BASE_URL, TRAVIS_COUNTY_ZIP, PROXY_LIST
...
def check_homestead_travis(street_name, first_name, last_name, current_row, total_rows):
